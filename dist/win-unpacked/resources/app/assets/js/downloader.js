...
var Downloader = function() {
    ...
    self.YD = new YoutubeMp3Downloader({
        "ffmpegPath": remote.getGlobal("ffmpeg"),        // Where is the FFmpeg binary located?
        "outputPath": remote.getGlobal("downloads"),            // Where should the downloaded and encoded files be stored?
